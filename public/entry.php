...
$assets=$mapAssets.'<link rel="stylesheet" href="/oyya-experience.css?v=2"><link rel="stylesheet" href="/oyya-modern-colors.css?v=1">'.$experienceAsset.'<script defer src="/oyya-nav-gesture.js?v=2"></script><script defer src="/oyya-composer.js?v=1"></script>';
